...
export default function FinanceDashboard({
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#070707] text-[#FFF8E6] flex flex-col items-center justify-center p-6 text-center space-y-4">
        <AlertTriangle className="w-12 h-12 text-[#FF1744]" />
        <p className="text-sm text-[#FFF8E6]/80">{error}</p>
        <button
          onClick={loadData}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#151516] border border-[#FFC400]/25 text-[#FFC400] hover:bg-[#FFC400]/10 text-xs font-bold transition-all cursor-pointer"
        >
