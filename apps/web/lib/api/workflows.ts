...
export const workflowsApi = {
  ...
  async setDefault(id: string): Promise<WorkflowTemplate> {
    return request(`/admin/workflows/templates//set-default`, {
      method: "POST",
    });
  },
  async createStage(
    ...
    return request(`/admin/workflows/templates//stages`, {
      method: "POST",
      body: JSON.stringify(payload),
    });
  },
  async updateStage(
    ...
    return request(`/admin/workflows/stages/`, {
      method: "PATCH",
      body: JSON.stringify(payload),
    });
  },
  ...
  async mapItem(
    ...
    return request(`/admin/workflows/stages//items`, {
      method: "POST",
      body: JSON.stringify(payload),
    });
  },
  ...
  async instantiateProjectServiceWorkflow(
    ...
    return request(`/projects//workflows/project-services//instantiate`, {
      method: "POST",
    });
  },
  async startWorkflow(
  ...
  async overrideDependency(
    ...
    return request(`/projects//workflows/dependencies//override`, {
      method: "POST",
